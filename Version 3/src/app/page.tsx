  ...
  if (!current) {
    return (
      <div className="mt-6 rounded-2xl border border-slate-200 bg-[var(--card)] p-6 dark:border-slate-800">
        ...
        <div className="mt-2 text-sm text-slate-600 dark:text-slate-400">Geh zu Settings und füge Starter-Karten hinzu.</div>
      </div>
    );
  }
      ...
      <div className="mt-6 grid gap-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-[var(--card)] p-6 shadow-sm dark:border-slate-800">
          ...
          {feedback && (
            ...
            >
              <div className="font-semibold">{feedback.ok ? "✅ Richtig!" : `❌ Falsch – richtig ist: ${feedback.correct}`}</div>
